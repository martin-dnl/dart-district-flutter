...
class GlowRectanglePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    const secondColor = AppColors.primary;
    ...
    final backgroundPaint = Paint()
      ..shader = ui.Gradient.radial(
        ...
        [
          Color.lerp(firstColor, AppColors.primary, progress)!.withOpacity(intensity),
          Color.lerp(firstColor, AppColors.primary, progress)!.withOpacity(0.0),
        ],
      )
