              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: !_acceptedRules || authState.status == AuthStatus.loading
                        ? null
                        : () {
                            ref.read(authControllerProvider.notifier).signUpWithEmail(
                                  username: (widget.payload['username'] ?? '').toString(),
                                  email: (widget.payload['email'] ?? '').toString(),
                                  password: (widget.payload['password'] ?? '').toString(),
                                  level: (widget.payload['level'] ?? '').toString(),
                                  preferredHand:
                                      (widget.payload['preferredHand'] ?? '').toString(),
                                );
                          },
